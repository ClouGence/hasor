...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
    ...
    public <T> T query(final String sql, final ResultSetExtractor<T> rse) throws DataAccessException {
        ...
        if (logger.isDebugEnabled()) {
            Hasor.debug("Executing SQL query [" + sql + "]");
        }
    ...
    public int update(final String sql) throws DataAccessException {
        Hasor.assertIsNotNull(sql, "SQL must not be null");
        if (logger.isDebugEnabled()) {
            Hasor.debug("Executing SQL update [" + sql + "]");
        }
    ...
    public int[] batchUpdate(final String[] sql) throws DataAccessException {
        ...
        if (logger.isDebugEnabled()) {
            Hasor.debug("Executing SQL batch update of " + sql.length + " statements");
        }
    ...
    public int[] batchUpdate(String sql, final BatchPreparedStatementSetter pss) throws DataAccessException {
        if (logger.isDebugEnabled()) {
            Hasor.debug("Executing SQL batch update [" + sql + "]");
        }
