...
import static org.platform.security.SecurityConfig.Security_ClientCookie_CookieName;
import static org.platform.security.SecurityConfig.Security_ClientCookie_Domain;
import static org.platform.security.SecurityConfig.Security_ClientCookie_Enable;
...
import static org.platform.security.SecurityConfig.Security_Enable;
import static org.platform.security.SecurityConfig.Security_EnableMethod;
import static org.platform.security.SecurityConfig.Security_EnableURL;
import static org.platform.security.SecurityConfig.Security_EncryptionDigestSet;
import static org.platform.security.SecurityConfig.Security_Forwards;
import static org.platform.security.SecurityConfig.Security_Guest_Account;
import static org.platform.security.SecurityConfig.Security_Guest_AuthSystem;
import static org.platform.security.SecurityConfig.Security_Guest_Enable;
import static org.platform.security.SecurityConfig.Security_Guest_Password;
import static org.platform.security.SecurityConfig.Security_Guest_Permissions;
import static org.platform.security.SecurityConfig.Security_Guest_UserCode;
import static org.platform.security.SecurityConfig.Security_LoginFormData_AccountField;
import static org.platform.security.SecurityConfig.Security_LoginFormData_AuthField;
import static org.platform.security.SecurityConfig.Security_LoginFormData_PasswordField;
import static org.platform.security.SecurityConfig.Security_LoginURL;
import static org.platform.security.SecurityConfig.Security_LogoutURL;
import static org.platform.security.SecurityConfig.Security_Rules_DefaultModel;
import static org.platform.security.SecurityConfig.Security_Rules_Excludes;
import static org.platform.security.SecurityConfig.Security_Rules_Includes;
