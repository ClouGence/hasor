 ...
 *
 * @see net.hasor.plugins.restful.api.HttpMethod#ANY
 * @see net.hasor.plugins.restful.api.HttpMethod#GET
 * @see net.hasor.plugins.restful.api.HttpMethod#POST
 * @see net.hasor.plugins.restful.api.HttpMethod#PUT
 * @see net.hasor.plugins.restful.api.HttpMethod#DELETE
 * @see net.hasor.plugins.restful.api.HttpMethod#HEAD
 * @see net.hasor.plugins.restful.api.HttpMethod#OPTIONS
 */
