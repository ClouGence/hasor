...
public abstract class StringConvertUtils {
    ...
    */
    ...
    public static Float parseFloat(final String value, final Float... defaultValue) {
        try {
            float var = StringUtils.isBlank(value) ? defaultValue[0] : Float.valueOf(value);
    ...
    public static Double parseDouble(final String value, final Double... defaultValue) {
        try {
            double var = StringUtils.isBlank(value) ? defaultValue[0] : Double.valueOf(value);
    ...
    public static Boolean parseBoolean(final String value, final Boolean... defaultValue) {
        if (value == null) {
            ...
            return StringConvertUtils.DefaultValue_Boolean; //false;
        else if (value.equals("1") == true || value.equals("yes") == true || value.equals("Y") == true)
            return !StringConvertUtils.DefaultValue_Boolean; //true;
        else
