...
import net.hasor.db.jdbc.types.handler.YearMonthOfNumberTypeHandler;
import net.hasor.db.jdbc.types.handler.YearMonthOfStringTypeHandler;
import net.hasor.db.jdbc.types.handler.YearMonthOfTimeTypeHandler;
