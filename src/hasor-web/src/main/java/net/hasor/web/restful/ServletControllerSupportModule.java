...
//import net.hasor.web.gift.listeners.ListenersGift;
//import net.hasor.web.restful.ActionManagerBuilder;
//import net.hasor.web.restful.HttpMethod;
//import net.hasor.web.restful.MergedController;
//import net.hasor.web.restful.Path;
//import net.hasor.web.restful.Produces;
//import net.hasor.web.restful.ActionBinder.ActionBindingBuilder;
//import net.hasor.web.restful.ActionBinder.NameSpaceBindingBuilder;
...
//        //
//        apiBinder.dependency().weak(ListenersGift.class);
//        //
