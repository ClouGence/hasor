...
//
public class ConstructorInjectSettingDefaultValueBean {
    ...
    //
    public ConstructorInjectSettingDefaultValueBean(//
            @InjectSettings("") byte byteValue          //
            , @InjectSettings("") Byte byteValue2       //
            , @InjectSettings("") short shortValue      //
            , @InjectSettings("") Short shortValue2     //
            , @InjectSettings("") int intValue          //
            , @InjectSettings("") Integer intValue2     //
            , @InjectSettings("") long longValue        //
            , @InjectSettings("") Long longValue2       //
            , @InjectSettings("") float floatValue      //
            , @InjectSettings("") Float floatValue2     //
            , @InjectSettings("") double doubleValue    //
            , @InjectSettings("") Double doubleValue2   //
            , @InjectSettings("") boolean booleanValue  //
            , @InjectSettings("") Boolean booleanValue2 //
            , @InjectSettings("") char charValue        //
            , @InjectSettings("") Character charValue2  //
            //
            , @InjectSettings("") Date dateValue1       //
            , @InjectSettings("") java.sql.Date dateValue2//
            , @InjectSettings("") Time dateValue3       //
            , @InjectSettings("") Timestamp dateValue4  //
            //
            , @InjectSettings("") String stringValue    //
            , @InjectSettings("") SingletonMode enumValue) {
        //
