...
import net.hasor.rsf.center.server.data.datafilter.RsfContext2ServerDODataFilter;
...
public class InitServerManager {
    ...
    public void init() throws Throwable {
        ...
        if (queryResult == null || queryResult.isSuccess() == false) {
        ...
        if (queryResult.getResult() == null) {
            ...
            if (insertResult == null || insertResult.isSuccess() == false || insertResult.getResult() == null || insertResult.getResult() <= 0) {
            ...
            if (updateResult == null || updateResult.isSuccess() == false || updateResult.getResult() == null || updateResult.getResult() == false) {
                IllegalStateException err = null;
    ...
    public void beatServer() throws IllegalStateException {
        ...
        //
        if (beatResult == null || beatResult.isSuccess() == false || beatResult.getResult() == null || beatResult.getResult() == false) {
            IllegalStateException err = null;
            if (beatResult != null) {
