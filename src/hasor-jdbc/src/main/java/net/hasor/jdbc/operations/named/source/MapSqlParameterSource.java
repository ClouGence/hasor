 ...
 */
package net.hasor.jdbc.operations.named.source;
import java.util.Collections;
import java.util.HashMap;
import java.util.Map;
import net.hasor.Hasor;
import net.hasor.jdbc.operations.named.NamedParameterJdbcTemplate;
import net.hasor.jdbc.operations.named.SqlParameterSource;
...
public class MapSqlParameterSource extends AbstractSqlParameterSource {
    ...
    public MapSqlParameterSource addValue(String paramName, Object value) {
        Hasor.assertIsNotNull(paramName, "Parameter name must not be null");
        this.values.put(paramName, value);
        if (value instanceof SqlVarParameter) {
            registerSqlType(paramName, ((SqlVarParameter) value).getSqlType());
        }
        return this;
    }
    /**
    ...
    public MapSqlParameterSource addValues(Map<String, ?> values) {
        if (values != null) {
            for (Map.Entry<String, ?> entry : values.entrySet()) {
                ...
                if (entry.getValue() instanceof SqlVarParameter) {
                    SqlVarParameter value = (SqlVarParameter) entry.getValue();
