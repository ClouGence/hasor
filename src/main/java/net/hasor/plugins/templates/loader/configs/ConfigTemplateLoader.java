 ...
 */
package net.hasor.plugins.templates.loader.configs;
import java.io.File;
...
import net.hasor.plugins.templates.StatefulTemplateLoader;
 ...
 */
class ConfigTemplateLoader implements TemplateLoader, StatefulTemplateLoader {
    ...
    public boolean exist(String resourcePath) {
        return this.objectMap.containsKey(resourcePath);
    }
}