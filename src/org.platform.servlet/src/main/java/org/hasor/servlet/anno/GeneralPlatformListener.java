...
// */
//@Module(displayName = "GeneralModuleServiceListener", description = "org.platform.general软件包功能支持。", startIndex = Module.Lv_1Max)
//public class GeneralPlatformListener extends WebHasorModule {
//    /**初始化.*/
//    @Override
