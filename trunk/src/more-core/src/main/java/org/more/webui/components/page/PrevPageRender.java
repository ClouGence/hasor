 ...
 */
@UIRender(tagName = "ui_pPrev")
public class PrevPageRender implements Render<PrevPageCom> {
    private boolean isRun(AbstractItemCom component) {
        PageCom page = (PageCom) component.getParent();
        return page.runMode == Mode.Prev;
    }
    @Override
    public void beginRender(ViewContext viewContext, PrevPageCom component, TemplateBody arg3, Writer writer) throws IOException, TemplateModelException {
