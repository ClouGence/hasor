...
public class QueryBuilderTest extends AbstractDbTest {
    ...
    public void queryBuilder1() {
        ...
        //
        BoundSql boundSql1 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "abc").getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM tb_user WHERE loginName = ?");
        assert boundSql1.getArgs()[0].equals("abc");
        //
        BoundSql boundSql2 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).eq(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql3 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().eq(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql4 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).ne(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql5 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().ne(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql6 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).gt(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql7 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().gt(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql8 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).ge(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql9 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().ge(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql10 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).lt(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql11 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().lt(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql12 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).le(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql13 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().le(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql14 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).isNull(TbUser::getAccount).getBoundSql();
        ...
        BoundSql boundSql15 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().isNull(TbUser::getAccount).getBoundSql();
        ...
        //
        BoundSql boundSql16 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).isNotNull(TbUser::getAccount).getBoundSql();
        ...
        BoundSql boundSql17 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().isNotNull(TbUser::getAccount).getBoundSql();
        ...
        BoundSql boundSql18 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).in(TbUser::getAccount, inData).getBoundSql();
        ...
        BoundSql boundSql19 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().in(TbUser::getAccount, inData).getBoundSql();
        ...
        BoundSql boundSql20 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).notIn(TbUser::getAccount, notInData).getBoundSql();
        ...
        BoundSql boundSql21 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().notIn(TbUser::getAccount, notInData).getBoundSql();
        ...
        //
        BoundSql boundSql22 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).between(TbUser::getAccount, 2, 3).getBoundSql();
        ...
        BoundSql boundSql23 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().between(TbUser::getAccount, 2, 3).getBoundSql();
        ...
        //
        BoundSql boundSql24 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).notBetween(TbUser::getAccount, 2, 3).getBoundSql();
        ...
        BoundSql boundSql25 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().notBetween(TbUser::getAccount, 2, 3).getBoundSql();
        ...
        //
        BoundSql boundSql26 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).like(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql27 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().notLike(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql28 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).likeRight(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql29 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().notLikeRight(TbUser::getAccount, "abc").getBoundSql();
        ...
        //
        BoundSql boundSql30 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).likeLeft(TbUser::getAccount, "abc").getBoundSql();
        ...
        BoundSql boundSql31 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getIndex, 1).or().notLikeLeft(TbUser::getAccount, "abc").getBoundSql();
    ...
    public void queryBuilder5() {
        JdbcTemplate jdbcTemplate = new JdbcTemplate();
        //
        BoundSql boundSql1 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "a").asc(TbUser::getAccount).getBoundSql();
        assert boundSql1.getSqlString().equals("SELECT * FROM tb_user WHERE loginName = ? ORDER BY loginName ASC");
        assert boundSql1.getArgs()[0].equals("a");
        //
        BoundSql boundSql2 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "a").asc(Arrays.asList(TbUser::getAccount, TbUser::getIndex)).getBoundSql();
        ...
        //
        BoundSql boundSql3 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "a").desc(TbUser::getAccount).getBoundSql();
        assert boundSql3.getSqlString().equals("SELECT * FROM tb_user WHERE loginName = ? ORDER BY loginName DESC");
        assert boundSql3.getArgs()[0].equals("a");
        //
        BoundSql boundSql4 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "a").asc(TbUser::getIndex).desc(TbUser::getAccount).getBoundSql();
        assert boundSql4.getSqlString().equals("SELECT * FROM tb_user WHERE loginName = ? ORDER BY index ASC , loginName DESC");
        assert boundSql4.getArgs()[0].equals("a");
        //
        BoundSql boundSql5 = jdbcTemplate.lambda(TbUser.class).eq(TbUser::getAccount, "a").orderBy(TbUser::getIndex).getBoundSql();
    ...
    public void queryBuilder6() {
        JdbcTemplate jdbcTemplate = new JdbcTemplate();
        //
        BoundSql boundSql1 = jdbcTemplate.lambda(TbUser.class).select("a", "b", "c", "d")//
    ...
    public void queryBuilder7() {
        JdbcTemplate jdbcTemplate = new JdbcTemplate();
        //
        BoundSql boundSql1 = jdbcTemplate.lambda(TbUser.class).select(Arrays.asList(TbUser::getAccount, TbUser::getIndex))//
                .eq(TbUser::getIndex, 1).or().between(TbUser::getAccount, 2, 3).getBoundSql();
    ...
    public void queryBuilder8() {
        JdbcTemplate jdbcTemplate = new JdbcTemplate();
        //
        BoundSql boundSql1 = jdbcTemplate.lambda(TbUser.class).select(TbUser::getAccount)//
                .eq(TbUser::getIndex, 1).or().between(TbUser::getAccount, 2, 3).getBoundSql();
