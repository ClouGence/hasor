...
import net.hasor.rsf.center.core.freemarker.loader.mto.AbstractTemplateObject;
import net.hasor.rsf.center.core.freemarker.loader.mto.ClassPath_TemplateObject;
import net.hasor.rsf.center.core.freemarker.loader.mto.File_TemplateObject;
import net.hasor.rsf.center.core.freemarker.loader.mto.String_TemplateObject;
import net.hasor.rsf.center.core.freemarker.loader.mto.URL_TemplateObject;
/**
 * 处理配置文件中添加的模板。
 * @version : 2011-9-14
