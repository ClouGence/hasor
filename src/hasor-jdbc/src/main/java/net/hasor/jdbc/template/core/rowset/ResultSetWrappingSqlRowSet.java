 ...
 */
package net.hasor.jdbc.template.core.rowset;
...
import net.hasor.jdbc.template.SqlRowSetMetaData;
 ...
 * appropriate Spring {@link InvalidDataAccessException}.
 *
...
public class ResultSetWrappingSqlRowSet implements SqlRowSet {
     ...
     * @throws InvalidDataAccessException if extracting
