...
// */
//public class JNDI_DataSourceFactory implements DataSourceResources {
//    //
...
//        int poolMaxSize = 200;
//        //
//        Hasor.info("C3p0 Pool Info maxSize is °Æ%s°Ø driver is °Æ%s°Ø jdbcUrl is°Æ%s°Ø", poolMaxSize, driverString, urlString);
//        //
