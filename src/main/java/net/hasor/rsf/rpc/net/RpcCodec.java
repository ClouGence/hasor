...
//        this.bindAddress = rsfNetManager.bindAddress("rsf");
//        this.gatewayAddress = rsfNetManager.getGatewayAddress("rsf");
//        this.rsfEnvironment = rsfNetManager.getRsfEnvironment();
