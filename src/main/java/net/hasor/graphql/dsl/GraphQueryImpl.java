...
class GraphQueryImpl implements GraphQuery {
    ...
    public static void buildQuery(final QueryDomain queryDomain, final boolean useFragment, final StringBuilder builder, final int depth) {
        GraphUDF graphUDF = queryDomain.getGraphUDF();
        if (graphUDF != null) {
    ...
    private static void buildParam(final StringBuilder builder, final boolean useFragment, final GraphValue param, final int depth) {
    ...
    private static void buildField(final String fieldName, final boolean useFragment, final GraphValue field, final StringBuilder builder, final int depth) {
        buildFieldKey(fieldName, field, builder);
        buildFieldValue(fieldName, useFragment, field, builder, depth);
    }
    private static void buildFieldKey(final String fieldName, final GraphValue field, final StringBuilder builder) {
    ...
    private static void buildFieldValue(final String fieldName, final boolean useFragment, final GraphValue field, final StringBuilder builder, final int depth) {
        if (field instanceof FixedValue) {
