...
class RefFlowControl {
    ...
    //
    private RefFlowControl() {}
    //
    public static final RefFlowControl defaultRef(RsfSettings rsfSettings) {
        RefFlowControl flowControlRef = new RefFlowControl();
