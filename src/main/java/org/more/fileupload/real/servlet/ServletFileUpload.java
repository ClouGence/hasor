 ...
 * Use {@link #getItemIterator(HttpServletRequest)} to acquire a list of
 * {@link org.more.fileupload.FileItem}s associated with a given HTML
 * widget.</p>
 *
...
public class ServletFileUpload extends FileUpload {
     ...
     * @return An iterator to instances of <code>FileItemStream</code> parsed from the request, in the order that they were transmitted.
