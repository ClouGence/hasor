 ...
 */
public class UserTypeConvert extends BaseTypeHandler<UserType> {
    private static Logger logger = LoggerFactory.getLogger(UserTypeConvert.class);
    @Override
    ...
    public UserType getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return UserType.formType(status);
    }
    @Override
