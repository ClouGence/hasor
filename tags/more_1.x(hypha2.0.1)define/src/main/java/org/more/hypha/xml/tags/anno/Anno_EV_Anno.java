 ...
 */
class Anno_EV_Anno implements AnnotationVisitor {
    private AnnoService       plugin  = null;
    private Anno_EV_Mark           mark    = null;
    private AnnotationVisitor visitor = null;
    //----------
    public Anno_EV_Anno(AnnoService plugin, Anno_EV_Mark mark, AnnotationVisitor visitor) {
        this.plugin = plugin;
        this.mark = mark;
    ...
    public AnnotationVisitor visitAnnotation(String name, String desc) {
        ...
        return new Anno_EV_Anno(this.plugin, this.mark, av);
    }
    /**数组类型值*/
