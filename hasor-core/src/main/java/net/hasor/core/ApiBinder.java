...
public interface ApiBinder {
    ...
    /** 添加SPI监听器 */
    public default <T extends EventListener> void bindSpiListener(Class<T> spiType, Class<? extends T> implementation) {
        this.bindSpiListener(spiType, getProvider(implementation));
    }
