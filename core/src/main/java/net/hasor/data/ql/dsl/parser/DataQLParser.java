...
import net.hasor.data.ql.dsl.domain.PrimitiveExpression.ValueType;
...
public class DataQLParser implements DataQLParserConstants {
    ...
    final public Expression unaryExpression() throws ParseException {
        ...
        case DECR: {
            ...
            case INCR: {
                symbol = jj_consume_token(INCR);
                break;
            }
            case DECR: {
                symbol = jj_consume_token(DECR);
                break;
            }
            default:
                jj_la1[14] = jj_gen;
            ...
            {
                if ("" != null)
                    return new UnaryExpression(target, symbol.image, UnaryLocation.Before);
            }
            break;
        }
        case INTEGER_NUM:
        ...
        case IDENTIFIER: {
            ...
            {
                if ("" != null)
                    return new UnaryExpression(target, symbol.image, UnaryLocation.After);
            }
            break;
        }
        default:
    ...
    // .参数集：(xx , xx , xx)
    final public void callerParamSet(CallerExpression callerExp) throws ParseException {
    ...
    // .异常
    final public ThrowInst throwBlock() throws ParseException {
        Number throwStatus = null;
        Expression throwData = null;
        jj_consume_token(THROW);
        if (jj_2_7(2147483647)) {
            throwStatus = throwBlockStatus();
        ...
        {
            if ("" != null)
                return new ThrowInst(throwStatus, throwData);
        }
        throw new Error("Missing return statement in function");
    }
    final public Number throwBlockStatus() throws ParseException {
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x0, 0x0, 0x6000000, 0x1f000, 0x20000000, 0x0, 0x40000000, 0x20000000, 0x40000000, 0x0, 0x80000000, 0x80000000, 0x0, 0xe01f000, 0x0, 0x0, 0xe01f000, 0x80000000, 0x0, 0x0, 0xe01f000, 0xe01f000, 0xf01f000, 0x20000000, 0x0, 0x0, 0x20000000, 0x0, 0x0, 0xf01f000, 0x40000, 0x80000, 0xe01f000, 0xe20000, 0xe20000, 0x0, 0x10000000, 0x0, };
    }
    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x100, 0x0, 0x0, 0x0, 0x0, 0x40, 0x0, 0x0, 0x0, 0x200, 0xffffc000, 0xffffc000, 0x10, 0x340, 0x3800, 0x3000, 0x3b40, 0xffffc000, 0xffffc000, 0x10, 0x340, 0x0, 0x3b50, 0x0, 0x10, 0x240, 0x0, 0x10, 0x200, 0x3b50, 0x0, 0x0, 0x3b50, 0x0, 0x0, 0x1, 0x0, 0x1, };
    }
    private static void jj_la1_init_2() {
        jj_la1_2 = new int[] { 0x800, 0x1a0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x3, 0x0, 0x9a0, 0x0, 0x0, 0x9a0, 0x3, 0x3, 0x0, 0x9a0, 0x1a0, 0x9a0, 0x0, 0x0, 0x1000, 0x0, 0x0, 0x0, 0x9a0, 0x0, 0x0, 0x9a0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }
