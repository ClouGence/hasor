...
/**
 * 推送默认方法级路由规则
 * @see net.hasor.rsf.center.server.push.RsfCenterPushEventEnum#UpdateDefaultMethodRouteEvent
 * @version : 2016年3月24日
 * @author 赵永春(zyc@hasor.net)
 */
@Singleton
public class UpdateDefaultMethodRouteProcessor extends PushProcessor {
    @Override
