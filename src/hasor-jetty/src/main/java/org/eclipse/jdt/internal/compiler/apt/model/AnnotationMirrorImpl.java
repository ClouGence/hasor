...
public class AnnotationMirrorImpl implements AnnotationMirror, InvocationHandler {
            ...
            for (int j = 0; j < length; j++) {
                ...
                if (pair.binding == pair2.binding) {
                    if (pair.value == null) {
                        ...
                        if (pair2.value == null || !pair2.value.equals(pair.value)) {
                            return false;
                        }
                    }
                    continue loop;
    ...
    public Map<? extends ExecutableElement, ? extends AnnotationValue> getElementValues() {
        ...
        Map<ExecutableElement, AnnotationValue> valueMap = new LinkedHashMap<ExecutableElement, AnnotationValue>(pairs.length);
    ...
    public Map<? extends ExecutableElement, ? extends AnnotationValue> getElementValuesWithDefaults() {
        ...
        Map<ExecutableElement, AnnotationValue> valueMap = new LinkedHashMap<ExecutableElement, AnnotationValue>();
    ...
    private Object getReflectionValue(Object actualValue, TypeBinding actualType, Class<?> expectedType) {
        ...
        if (expectedType.isArray()) {
            if (Class.class.equals(expectedType.getComponentType())) {
                ...
                if (actualType.isArrayType() && actualValue instanceof Object[] && ((ArrayBinding) actualType).leafComponentType.erasure().id == TypeIds.T_JavaLangClass) {
