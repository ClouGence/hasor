...
import org.more.hypha.define.beans.List_ValueMetaData;
import org.more.hypha.define.beans.Map_ValueMetaData;
...
public class TagBeans_Map extends TagBeans_AbstractCollection<Map_ValueMetaData> {
    ...
    public TagBeans_Map(XmlDefineResource configuration) {
        super(configuration);
    }
