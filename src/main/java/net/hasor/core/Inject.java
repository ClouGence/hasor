 ...
 * <ul>
 * <li>“byType=Type.ByType”使用“{@code AppContext.getInstance(Class)}”方式进行依赖注入。</li>
...
public @interface Inject {
    ...
    /**区分注入Bean的方式<ul>
     * <li>“byType=Type.ByID”使用“{@code AppContext.getInstance(String)}”方式进行依赖注入。</li>
     * <li>(默认配置)“byType=Type.ByType”使用“{@code AppContext.findBindingBean(withName, bindType)}”方式进行依赖注入。</li>
     * </ul>*/
    public Type byType() default Type.ByType;
}