...
public class BeanEngine {
    ...
    public void init(ApplicationContext context, IAttribute flash) throws Throwable {
        ...
        this.classLoader = new EngineClassLoader(this.getContext().getBeanClassLoader());//使用EngineClassLoader装载构造的字节码
    }
    //----------------------------------------------------------------------------------------------------------
    ...
    public final synchronized Object builderBean(AbstractBeanDefine define, Object[] params) throws Throwable {
        ...
        //1.创建
        Object obj = this.getExpandPointManager().exePointOnReturn(BeforeCreatePoint.class, //预创建Bean
            ...
            if (builder.ifDefaultBeanCreateMode() == false)
                ...
                if (factory != null) {
                    ...
                    if (factory.isStatic() == true) {
                        ...
                        Object factoryObject = this.getContext().getBean(factoryBeanID, params);/*params参数会被顺势传入工厂bean中。*/
        ...
        //5.执行扩展点
        obj = this.getExpandPointManager().exePointOnSequence(AfterCreatePoint.class,//Bean装饰
