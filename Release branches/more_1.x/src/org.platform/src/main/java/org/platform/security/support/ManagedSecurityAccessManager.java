...
class ManagedSecurityAccessManager {
    ...
    public void initManager(AppContext appContext) {
        ...
        Platform.info("managedSecurityAccessManager initialized.");
    }
    ...
    public void destroyManager(AppContext appContext) {
        Platform.info("destroy ManagedSecurityAccessManager...");
    ...
    public ISecurityAccess getSecurityAccess(String authSystem, AppContext appContext) {
