...
import org.more.hypha.xml.event.XmlLoadedEvent.Params;
...
public class TagListener implements EventListener<XmlLoadedEvent> {
    ...
    public void onEvent(final XmlLoadedEvent event, final Sequence sequence) {
        ...
        try {
            ...
            final AnnoResourcePlugin engine = (AnnoResourcePlugin) config.getFlash().getAttribute(AnnoResourcePlugin.AnnoDefineResourcePluginName);
            //
