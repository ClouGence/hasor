...
import net.hasor.test.beans.basic.implby.endsingleton.EsImplSampleBean;
import net.hasor.test.beans.basic.implby.endsingleton.EsSampleBeanFaceByFace;
import net.hasor.test.beans.basic.implby.firstsingleton.FsImplSampleBean;
import net.hasor.test.beans.basic.implby.firstsingleton.FsSampleBeanFaceByFace;
import net.hasor.test.beans.basic.implby.middlesingleton.MsImplSampleBean;
import net.hasor.test.beans.basic.implby.middlesingleton.MsSampleBeanFaceByFace;
import net.hasor.test.beans.basic.inject.constructor.*;
