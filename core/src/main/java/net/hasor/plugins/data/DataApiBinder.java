...
public interface DataApiBinder extends ApiBinder {
    ...
    /** 添加数据源 */
    public void addDataSource(String name, DataSource dataSource) throws Throwable;

    /** 添加数据源 */
    public void addDataSource(String name, Provider<DataSource> dataSource) throws Throwable;
}