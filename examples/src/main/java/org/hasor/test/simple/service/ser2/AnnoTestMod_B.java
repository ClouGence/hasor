 ...
 */
package org.hasor.test.simple.service.ser2;
 ...
 */
@AnnoModule
public class AnnoTestMod_B implements Module {
    private List<AbstractService> serSet = new ArrayList<AbstractService>();
    //
    public void init(ApiBinder apiBinder) {
        System.out.println("AnnoTestMod_B");
    }
    public void start(AppContext appContext) {
        serSet.add(new SerB1());
        serSet.add(new SerB2());
        //
