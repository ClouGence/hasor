 ...
 */
class Anno_EV_Field implements FieldVisitor {
    private Anno_EV_Mark      mark    = null;
    private FieldVisitor visitor = null;
    private AnnoService  plugin  = null;
    //----------
    public Anno_EV_Field(AnnoService plugin, Anno_EV_Mark mark, FieldVisitor visitor) {
        this.plugin = plugin;
        this.mark = mark;
    ...
    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
        ...
        return new Anno_EV_Anno(this.plugin, this.mark, this.visitor.visitAnnotation(desc, visible));
    }
