...
public class HasorRegisterFactory extends AbstractRegisterFactory {
    ...
    protected <T> AbstractRegisterInfoAdapter<T> createRegisterInfoAdapter(Class<T> bindingType) {
        HasorRegisterInfoAdapter<T> adapter = new HasorRegisterInfoAdapter<T>();
    ...
    public <T> T getInstance(RegisterInfo<T> oriType) {
        ...
        //
        if (oriType instanceof HasorRegisterInfoAdapter) {
            Key<T> key = ((HasorRegisterInfoAdapter<T>) oriType).getKey();
        ...
        this.guiceInjector = this.createInjector(new Module() {
            public void configure(Binder binder) {
                ...
                while (registerIterator.hasNext()) {
                    HasorRegisterInfoAdapter<Object> register = (HasorRegisterInfoAdapter<Object>) registerIterator.next();
                    //1.处理绑定
    ...
    private void configRegister(HasorRegisterInfoAdapter<Object> register, Binder binder) {
