 ...
 */
package org.more.hypha.xml.tags.anno;
 ...
 */
class Anno_EV_Method extends MethodAdapter {
    private AnnoService plugin = null;
    private Anno_EV_Mark     mark   = null;
    //----------
    public Anno_EV_Method(AnnoService plugin, Anno_EV_Mark mark, MethodVisitor mv) {
        super(mv);
        this.plugin = plugin;
        this.mark = mark;
    }
    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
        ...
        return new Anno_EV_Anno(this.plugin, this.mark, super.visitAnnotation(desc, visible));
    }
    public AnnotationVisitor visitParameterAnnotation(int parameter, String desc, boolean visible) {
        ...
        if (this.plugin.containsKeepWatchParser(annoType) == true)
            this.mark.mark(annoType);
        return new Anno_EV_Anno(this.plugin, this.mark, super.visitParameterAnnotation(parameter, desc, visible));
    }
