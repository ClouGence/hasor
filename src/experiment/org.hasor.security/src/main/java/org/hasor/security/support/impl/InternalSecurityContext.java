 ...
 */
package org.hasor.security.support.impl;
...
import org.hasor.security.support.AbstractSecurityContext;
import org.hasor.security.support.SessionData;
import com.google.inject.Singleton;
/**
 * ƒ⁄÷√SecurityContext¿‡ µœ÷
 * @version : 2013-4-20
...
public class InternalSecurityContext extends AbstractSecurityContext {
    ...
    public synchronized void initSecurity(AppContext appContext) {
        ...
        if (authSessionCache == null)
            throw new NullPointerException("not load AuthSessionCache °Æ" + cacheName + "°Ø");
