...
create table interface_release (
    pub_id           serial constraint pk_interface_release primary key,
    ...
    pub_schema       text               NULL,
    pub_sample       text               NULL,
    pub_option       text               NULL,
    pub_release_time timestamp    DEFAULT(now())
);
