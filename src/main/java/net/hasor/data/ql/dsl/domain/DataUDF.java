...
public class DataUDF {
    ...
    private Map<String, DValue> paramMap   = new HashMap<String, DValue>();
    //
    public DataUDF(String funSpace, String funName) {
        this.funSpace = funSpace;
        this.funName = funName;
    }
    public void addParam(String paramName, DValue dValue) {
        if (this.paramMap.containsKey(paramName)) {
            throw new RuntimeException(paramName);
        }
        this.paramNames.add(paramName);
        this.paramMap.put(paramName, dValue);
    }
    ...
    public DValue getParam(String paramName) {
