 ...
 */
package net.test.simple.beans;
import java.io.IOException;
import java.net.URISyntaxException;
import net.hasor.core.context.AnnoStandardAppContext;
import net.test.simple.beans.beans.NamesBean;
import net.test.simple.beans.beans.SingletonBean;
import net.test.simple.beans.customer.CustomerBean;
