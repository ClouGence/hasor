...
import net.hasor.test._.ArraysRenderEngine;
import net.hasor.test._.HtmlRealRennerAction;
...
//
public class DefaultRenderEngineTest extends AbstractWeb30BinderDataTest {
