...
import net.hasor.test.beans.aop.anno.ClassAnnoInterceptor;
import net.hasor.test.beans.aop.anno.MethodAnnoInterceptor;
import net.hasor.test.beans.aop.custom.ClassMyAopBean;
import net.hasor.test.beans.aop.custom.MethodMyAopBean;
