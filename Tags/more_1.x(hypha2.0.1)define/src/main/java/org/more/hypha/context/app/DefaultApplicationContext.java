...
public class DefaultApplicationContext extends AbstractApplicationContext {
    ...
    // 
    public DefaultApplicationContext() throws Throwable {
        super(null);
        XmlDefineResource adr = new XmlDefineResource();//必须用XmlDefineResource否则beans可能无法被装载。
        adr.loadDefine();
        this.defineResource = adr;
    }
    public DefaultApplicationContext(AbstractDefineResource defineResource) throws NullPointerException, MoreStateException {
        super(null);
