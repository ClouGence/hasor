...
import net.hasor.dataql.domain.ast.expr.*;
import net.hasor.dataql.domain.ast.format.ListFormat;
import net.hasor.dataql.domain.ast.format.ObjectFormat;
import net.hasor.dataql.domain.ast.inst.*;
import net.hasor.dataql.domain.ast.inst.ImportInst.ImportType;
import net.hasor.dataql.domain.ast.value.*;
import net.hasor.dataql.domain.ast.value.EnterRouteVariable.RouteType;
import net.hasor.dataql.domain.ast.value.PrimitiveVariable.ValueType;
import net.hasor.dataql.domain.ast.value.SubscriptRouteVariable.SubType;
...
public class DefaultDataQLVisitor<T> extends AbstractParseTreeVisitor<T> implements DataQLVisitor<T> {
    ...
    public T visitPrivilegeExpr(PrivilegeExprContext ctx) {
        ...
        throw new RuntimeException("paser failed -> visitPrivilegeExpr.");
    }
