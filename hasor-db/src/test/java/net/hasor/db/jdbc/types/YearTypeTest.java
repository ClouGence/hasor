...
import net.hasor.db.jdbc.types.handler.YearOfNumberTypeHandler;
import net.hasor.db.jdbc.types.handler.YearOfStringTypeHandler;
import net.hasor.db.jdbc.types.handler.YearOfTimeTypeHandler;
