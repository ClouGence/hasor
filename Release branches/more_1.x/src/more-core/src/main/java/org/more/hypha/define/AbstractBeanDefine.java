 ...
 */
public abstract class AbstractBeanDefine extends AbstractDefine<AbstractBeanDefine> {
    ...
    private AbstractBeanDefine              useTemplate   = null;                                       //应用的模板
    //-------------------------------------------------------------
    ...
    public void addInitParam(ConstructorDefine constructorParam) {
        ...
        final AbstractBeanDefine define = this;
