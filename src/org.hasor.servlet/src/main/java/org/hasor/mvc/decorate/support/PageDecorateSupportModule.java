...
import org.hasor.mvc.decorate.DecorateBinder.DecorateFilterBindingBuilder;
...
public class PageDecorateSupportModule extends AbstractWebHasorModule {
    ...
    private Map<String, XmlProperty> loadCreator(Settings settings) {
        ...
        XmlProperty[] xmlPropArray = settings.getXmlPropertyArray("hasor-mvc.pageDecorate.processor");
    ...
    private void loadFilter(WebApiBinder binder, DecorateBinder decorateBinder, Map<String, XmlProperty> creator) {
        //pageDecorate
        XmlProperty[] xmlPropArray = binder.getInitContext().getSettings().getXmlPropertyArray("hasor-mvc.pageDecorate");
        for (XmlProperty xmlProp : xmlPropArray)
