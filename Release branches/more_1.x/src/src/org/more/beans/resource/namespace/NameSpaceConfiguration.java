...
/**
 * 该类是为了解析regedit.xm而设立的。
 * @version 2010-9-24
 * @author 赵永春 (zyc@byshell.org)
 */
public class NameSpaceConfiguration implements XmlAccept {
    ...
    private void processRegedit(XmlStreamEvent e) {
        if (e instanceof StartElementEvent) {
            ...
            try {
                ...
                NameSpaceRegedit obj = (NameSpaceRegedit) factory.newInstance();
                obj.initRegedit(this.currentNamespace.toString(), this.config);
