...
public abstract class ResourcesUtil {
    ...
    public static void scan(String wild, ScanItem item) throws Throwable {
        ...
        Enumeration<URL> urls = Thread.currentThread().getContextClassLoader().getResources(_wild);
    ...
    private static List<URL> rootDir() throws IOException {
        Enumeration<URL> roote = Thread.currentThread().getContextClassLoader().getResources("");
