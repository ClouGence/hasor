...
public class InMappingDefTest {
    ...
    public void asyncTest() throws Throwable {
        ...
        assert mappingDef1.isAsync(invoker1);
        //
        //
    ...
    public void httpTest() throws Throwable {
        ...
        //
        InMappingDef mappingDef = new InMappingDef(1, targetInfo, "/execute.do", Matchers.anyMethod(), false);
        assert mappingDef.findMethod(invoker1).getName().equals("execute1");
        assert mappingDef.findMethod(invoker2).getName().equals("execute2");
        assert mappingDef.findMethod(invoker3).getName().equals("execute3");
        assert mappingDef.findMethod(invoker4).getName().equals("execute3");
        assert mappingDef.findMethod(invoker5) == null;
        //
    ...
    public void matchingTest() throws Throwable {
        ...
        //
        assert mappingDef.matchingMapping(invoker1);
        assert !mappingDef.matchingMapping(invoker2);
        assert !mappingDef.matchingMapping(invoker3);
