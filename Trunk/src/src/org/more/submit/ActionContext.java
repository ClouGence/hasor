 ...
 * 检测一个action的过程如下：1.名字检测 NoDefinitionException，2.Action标记检测  NoDefinitionException，3.对象检测 CastException
 * @version 2009-11-28
...
public interface ActionContext {
    ...
    /**
     * 查找并且返回目标Action对象，findAction方法并不会装配其action过滤器，如果无法查找或者查找action调用目标失败则会引发NoDefinitionException异常。
     * <br/>该方法会引发检测程序的所有环节。
