 ...
 */
package org.hasor.test.ext.mappingfile.context;
import java.io.File;
import java.io.IOException;
import java.net.URI;
import java.net.URISyntaxException;
import org.hasor.test.ext.mappingfile.environment.MappingEnvironment;
...
public class MappingAppContext extends StandardAppContext {
    /** */
    public MappingAppContext() throws IOException {
        super();
    }
    /***/
    ...
    protected Environment createEnvironment() {
        return new MappingEnvironment(this.getMainSettings());
    }
}