...
import org.more.util.map.IntHashMap;
 ...
 * </p>
 *
 * @see <a href="http://hotwired.lycos.com/webmonkey/reference/special_characters/">ISO EntitiesUtils</a>
 * @see <a href="http://www.w3.org/TR/REC-html32#latin1">HTML 3.2 Character EntitiesUtils for ISO Latin-1</a>
 ...
 * @since 2.0
 * @version $Id: EntitiesUtils.java 911986 2010-02-19 21:19:05Z niallp $
 */
public class EntitiesUtils {
     ...
     * </p>
     */
    public static final EntitiesUtils XML;
    /**
     * <p>
     * The set of entities supported by HTML 3.2.
     * </p>
     */
    public static final EntitiesUtils HTML32;
    /**
     * <p>
     * The set of entities supported by HTML 4.0.
     * </p>
     */
    public static final EntitiesUtils HTML40;

    static {
        EntitiesUtils xml = new EntitiesUtils();
        xml.addEntities(BASIC_ARRAY);
        xml.addEntities(APOS_ARRAY);
        XML = xml;
    }
    static {
        EntitiesUtils html32 = new EntitiesUtils();
        html32.addEntities(BASIC_ARRAY);
        html32.addEntities(ISO8859_1_ARRAY);
        HTML32 = html32;
    }
    static {
        EntitiesUtils html40 = new EntitiesUtils();
     ...
     */
    static void fillWithHtml40Entities(EntitiesUtils entities) {
    ...
    static abstract class MapIntMap implements EntitiesUtils.EntityMap {
    ...
    public EntitiesUtils() {
        map = new EntitiesUtils.LookupEntityMap();
    }
    /**
    ...
    public String escape(String str) {
        ...
        try {
            ...
            // This should never happen because ALL the StringWriter methods called by #escape(Writer, String) do not throw IOExceptions.
