...
import net.hasor.neuron.election.ElectionServiceManager;
import net.hasor.neuron.node.AskNameService;
import net.hasor.neuron.node.ServerNode;
 ...
 */
public class RsfNeuronModule extends RsfModule implements ContextStartListener {
    @Override
    ...
    public void doStartCompleted(AppContext appContext) {
        ...
        appContext.getEnvironment().getEventContext().fireAsyncEvent(NeuronEvent.ServerStatus, ServerStatus.Follower);
    }
}