 ...
 */
public class TagSubmit_AC extends TagSubmit_NS implements XmlElementHook {
    private B_Config config = null;
    /**创建{@link TagSubmit_AC}对象*/
    public TagSubmit_AC(XmlDefineResource configuration, B_Config config) {
        super(configuration);
        this.config = config;
    }
    /**开始标签解析expression属性。*/
