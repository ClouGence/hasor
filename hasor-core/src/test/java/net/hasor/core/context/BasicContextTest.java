...
public class BasicContextTest {
    ...
    //        Environment env = new StandardEnvironment(null);
    //        StatusAppContext appContext = new StatusAppContext(env);
    //        //
    //        try {
    ...
    //        final CreaterProvisionListener createrListener = (newObject, bindInfo) -> dataMap.put(newObject.getClass().getName(), bindInfo);
    //        //
