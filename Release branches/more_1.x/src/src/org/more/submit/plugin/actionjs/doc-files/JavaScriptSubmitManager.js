...
more.util.AjaxCall = function(obj) {
	...
	this.call = function(args) {
		...
		ajax.setRequestHeader("Content-Type",
				"application/x-www-form-urlencoded; charset=UTF-8");// 设置请求格式
...
more.util.toObject = function(str) {
	...
	} else if ((new RegExp("^N\\|(\\+|-)?\\d{0,}(\\.\\d+){0,}$", "gi"))
			.test(str) == true) {
		// 数字
...
more.retain.callServerFunction = function(callName, funArray) {
	...
	return (typeof (result_return) == "undefined") ? result : more.util
			.toObject(result);
};
/* ====================================================================== */
more.retain.serverCallURL = "http://127.0.0.1:8080/post://mrmiAction.execute";