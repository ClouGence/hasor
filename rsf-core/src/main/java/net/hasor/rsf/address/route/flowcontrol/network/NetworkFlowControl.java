 ...
 */
package net.hasor.rsf.address.route.flowcontrol.network;
 ...
 * &lt;/flowControl&gt;
 * </pre>
 * 解释： 对某一服务，开启本地路由优先调用策略
 * 但当本地网络内的可用机器的数量占服务地址全部数量的比例小于0.3时，本地网络优先调用策略失效，启用跨路由调用。
