...
public interface GraphParserConstants {
    ...
    String[] tokenImage             = { "<EOF>", "<C_SINGLE_COMMENT>", "<C_MULTILINE_COMMENT>", "<SH_SINGLE_COMMENT>", "<WHITESPACE>", "<EOL>", "\",\"", "\"(\"", "\")\"", "\"[\"", "\"]\"", "\"{\"", "\"}\"", "\":\"", "\"=\"", "\"...\"", "\"\\\'\"", "\"\\\"\"", "\"fragment\"", "\"on\"", "\"true\"", "\"false\"", "\"null\"", "\"0\"", "<DIGIT_NONZERO>", "<DIGIT>", "<NUMBER_INTEGER>", "<NUMBER_DECIMAL>", "\"\\\'\\\'\"", "\"\\\"\\\"\"", "<STRING_SINGLE_BODY>", "<STRING_DOUBLE_BODY>", "<STRING_SINGLE_NONEMPTY>", "<STRING_DOUBLE_NONEMPTY>", "<NAME_LITERAL>", };
}
