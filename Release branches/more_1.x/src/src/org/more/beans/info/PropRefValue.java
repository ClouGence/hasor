...
/**
 * 代表一个引用对象类型属性的定义。引用类型一共分为四类它们是【上下文属性、引用其他bean定义、引用创建参数、元信息属性】。<br/><br/>
 * 一、上下文属性（PRV_ContextAtt）：<br/>
