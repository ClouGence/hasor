...
import net.test.hasor.core._06_aop.objs.CustomAnnoFooBean;
import net.test.hasor.core._06_aop.objs.FooBean;
import net.test.hasor.core._06_aop.objs.MyAop;
import net.test.hasor.core._06_aop.objs.SimpleInterceptor;
