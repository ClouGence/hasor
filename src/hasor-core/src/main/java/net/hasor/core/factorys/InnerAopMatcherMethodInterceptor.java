 ...
 */
class InnerAopMatcherMethodInterceptor implements AopMatcherMethodInterceptor {
    ...
    //
    public InnerAopMatcherMethodInterceptor(final Matcher<Class<?>> matcherClass, final Matcher<Method> matcherMethod, final MethodInterceptor interceptor) {
