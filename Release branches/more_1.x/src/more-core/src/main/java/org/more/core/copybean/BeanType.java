 ...
 */
public abstract class BeanType<T> implements Serializable {
     ...
     */
    Map<String, PropertyReaderWrite<T>> getPropertys(T object) {
        BeanType.log.debug("BeanType getPropertys at class =" + object.getClass().getName() + " obj= " + object);
        Hashtable<String, PropertyReaderWrite<T>> map = new Hashtable<String, PropertyReaderWrite<T>>();
        //
        ...
        while (iterator.hasNext()) {
            ...
            PropertyReaderWrite<T> rw = this.getPropertyRW(object, ns);
            if (rw != null)
                map.put(ns, rw);
     ...
     */
    protected abstract Iterator<String> iteratorNames(T obj);
    /**
     ...
     */
    protected abstract PropertyReaderWrite<T> getPropertyRW(T obj, String name);
    /**
