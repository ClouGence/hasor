 ...
 */
public class PropertyBindingImpl implements PropertyBinding {
    ...
    public PropertyBindingImpl(AbstractELContext elContext, String propertyEL, Object object) throws OgnlException {
        this.ognlContext = new OgnlContext(elContext.getThisAttribute().toMap());
