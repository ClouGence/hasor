...
import net.hasor.security._.PermissionException;
import net.hasor.security._.Power;
...
import net.hasor.security._.Power.Level;
import net.hasor.security._.support.impl.InternalSecurityContext;
import net.hasor.security._.support.process.AuthRequestProcess;
import net.hasor.security._.support.process.TestPermissionProcess;
...
import org.hasor.icache.support.CacheSupportModule;
 ...
 */
@Module(description = "org.hasor.security软件包功能支持。")
