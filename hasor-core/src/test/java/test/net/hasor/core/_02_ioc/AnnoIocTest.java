 ...
 */
package test.net.hasor.core._02_ioc;
import com.alibaba.fastjson.JSON;
import net.hasor.core.ApiBinder;
import net.hasor.core.AppContext;
import net.hasor.core.Hasor;
import net.hasor.core.Module;
import test.net.hasor.core.pojos.PojoBean;
import test.net.hasor.core.pojos.PojoInfo;
import test.net.hasor.core.pojos.AnnoIocBean;
import test.net.hasor.core.pojos.CustomIocBean;
import test.net.hasor.core.pojos.NameIocBean;
