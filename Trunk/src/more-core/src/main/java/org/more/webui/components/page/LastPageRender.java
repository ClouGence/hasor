...
public class LastPageRender implements Render<LastPageCom> {
    private boolean isRun(AbstractItemCom component) {
        PageCom page = (PageCom) component.getParent();
        return page.runMode == Mode.Last;
    }
    @Override
    public void beginRender(ViewContext viewContext, LastPageCom component, TemplateBody arg3, Writer writer) throws IOException, TemplateModelException {
