 ...
 */
public class AopPointcutGroupDefine extends AopAbstractPointcutDefine {
    ...
    private ArrayList<AopAbstractPointcutDefine> defineList = new ArrayList<AopAbstractPointcutDefine>();
    ...
    public List<AopAbstractPointcutDefine> getPointcutList() {
