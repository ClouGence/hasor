 ...
 */
package net.test.hasor.db._06_transaction.plugins.NEVER;
...
import net.hasor.plugins.tran.interceptor.RollBackSQLException;
...
public class HaveTarn_NEVER_Test extends AbstractSimpleJDBCTest {
    @Test
