...
import net.hasor.mvc.restful.AttributeParam;
import net.hasor.mvc.restful.CookieParam;
import net.hasor.mvc.restful.HeaderParam;
import net.hasor.mvc.restful.PathParam;
import net.hasor.mvc.restful.QueryParam;
