...
import net.hasor.test.beans.aop.ignore.level.LevelFooFunction;
import net.hasor.test.beans.aop.ignore.level.l2.L2FooFunction;
import net.hasor.test.beans.aop.ignore.thread.ThreadFooFunction;
import net.hasor.test.beans.aop.ignore.types.*;
import net.hasor.test.beans.basic.destroy.NonePrivateCallDestroyBean;
import net.hasor.test.beans.basic.destroy.NonePublicCallDestroyBean;
import net.hasor.test.beans.basic.destroy.WithoutAnnoCallDestroyBean;
import net.hasor.test.beans.basic.implby.ImplSampleBean;
import net.hasor.test.beans.basic.implby.SampleBeanFace;
import net.hasor.test.beans.basic.implby.SampleBeanFaceByFace;
import net.hasor.test.beans.basic.init.NonePrivateCallInitBean;
import net.hasor.test.beans.basic.init.NonePublicCallInitBean;
import net.hasor.test.beans.basic.init.WithoutAnnoCallInitBean;
import net.hasor.test.beans.basic.inject.ByIDPropertyPojoBeanRef;
import net.hasor.test.beans.basic.inject.ByNamePropertyPojoBeanRef;
...
import net.hasor.test.beans.basic.inject.jsr330.Jsr330BasicRef;
import net.hasor.test.beans.basic.inject.jsr330.Jsr330ConstructorRef;
...
public class ContainerUtilsTest {
    ...
    public void jsrInject1() throws NoSuchFieldException {
        ...
        assert injectAnno_3 instanceof Named && ((Named) injectAnno_3).value().equals("net.hasor.test.beans.basic.inject.jsr330.ByOrder");
        assert injectAnno_4 instanceof Named && ((Named) injectAnno_4).value().equals("net.hasor.test.beans.basic.inject.jsr330.ByOrder");
        assert injectAnno_5 instanceof Named && ((Named) injectAnno_5).value().equals("net.hasor.test.beans.basic.inject.jsr330.ByOrder");
        assert injectAnno_6 instanceof Named && ((Named) injectAnno_6).value().equals("net.hasor.test.beans.basic.inject.jsr330.ByOrder");
    }
