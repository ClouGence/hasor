 ...
 */
public class SqlInputVarParameter extends SqlInputParameter {
    private final Object value;
    /**创建一个匿名的 SQL 参数.*/
    public SqlInputVarParameter(int sqlType, Object value) {
        super(sqlType);
        this.value = value;
    }
    /**根据参数名 和参数类型创建一个 SqlParameter.*/
    public SqlInputVarParameter(String name, int sqlType, Object value) {
        super(name, sqlType);
        this.value = value;
    }
    /**
