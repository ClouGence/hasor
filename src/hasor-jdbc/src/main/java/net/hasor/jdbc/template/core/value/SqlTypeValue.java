 ...
 */
package net.hasor.jdbc.template.core.value;
 ...
 * effectively an extended variant of {@link net.hasor.jdbc.template.core.value.SqlValue}.
 *
 ...
 * @see net.hasor.jdbc.template.core.value.SqlValue
 */
