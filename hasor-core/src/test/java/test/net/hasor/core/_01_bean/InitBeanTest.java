 ...
 */
package test.net.hasor.core._01_bean;
...
import test.net.hasor.core.pojos.InitBean;
import test.net.hasor.core.pojos.InitBean2;
import test.net.hasor.core.pojos.StartInitBean;
/**
 * 1.initTest
