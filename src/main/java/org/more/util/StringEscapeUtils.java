...
public class StringEscapeUtils {
            ...
            if (inUnicode) {
                ...
                if (unicode.length() == 4) {
                    ...
                    try {
                        ...
                        throw new FormatException("Unable to parse unicode value: " + unicode, nfe);
                    }
                }
                continue;
            }
    ...
    public static void escapeHtml(Writer writer, String string) throws IOException {
        ...
        EntitiesUtils.HTML40.escape(writer, string);
    }
    //-----------------------------------------------------------------------
    /**
    ...
    public static void unescapeHtml(Writer writer, String string) throws IOException {
        ...
        EntitiesUtils.HTML40.unescape(writer, string);
    }
    //-----------------------------------------------------------------------
    /**
    ...
    public static void escapeXml(Writer writer, String str) throws IOException {
        ...
        EntitiesUtils.XML.escape(writer, str);
    }
    /**
     * <p>Escapes the characters in a <code>String</code> using XML entities.</p>
     *
    ...
    public static void unescapeXml(Writer writer, String str) throws IOException {
        ...
        EntitiesUtils.XML.unescape(writer, str);
    }
    /**
     * <p>Unescapes a string containing XML entity escapes to a string
     * containing the actual Unicode characters corresponding to the
    ...
    public static String unescapeXml(String str) {
        ...
        return EntitiesUtils.XML.unescape(str);
    }
    //-----------------------------------------------------------------------
    /**
