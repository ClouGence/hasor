 ...
 */
public class EvalExpressionImpl implements EvalExpression {
    private String     expressionString = null;
    private Node       expressionNode   = null;
    private IAttribute attribute        = null;
    /***/
    public EvalExpressionImpl(AbstractELContext abstractELContext, String expressionString) throws OgnlException {
