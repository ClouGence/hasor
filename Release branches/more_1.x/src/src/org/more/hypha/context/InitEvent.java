...
public class InitEvent extends Event {
    private static ILog log = LogFactory.getLog(InitEvent.class);
    public class InitEvent_Params extends Event.Params {
        public ApplicationContext applicationContext = null;
    };
    public InitEvent_Params toParams(Sequence eventSequence) {
        Object[] params = eventSequence.getParams();
        log.debug("Sequence to Params ,params = {%0}", params);
        InitEvent_Params p = new InitEvent_Params();
