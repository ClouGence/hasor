...
import net.hasor.boot.launcher.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
    ...
    private void clearCache(URLConnection connection) throws IOException {
        ...
        if (jarFile instanceof net.hasor.boot.launcher.jar.JarFile) {
            ((net.hasor.boot.launcher.jar.JarFile) jarFile).clearCache();
        }
    }
